...
<div class="container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <a href="<?= site_url('hospitalizacion') ?>" class="card card-modulo card-principales p-4 d-block">
        ...
        <div class="col-md-6">
            <a href="<?= site_url('hospitalizacion/lista_hospitalizaciones') ?>" class="card card-modulo card-hosp p-4 d-block">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <a href="<?= site_url('hospitalizacion/lista_salas') ?>" class="card card-modulo card-salas p-4 d-block">
        ...
        <div class="col-md-6">
            <a href="<?= site_url('hospitalizacion/lista_tipos_diagnostico') ?>" class="card card-modulo card-tipos p-4 d-block">
